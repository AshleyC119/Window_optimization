...
| Arm | 算法 | 评估器 | 墙钟 | Knee |
|---|---|---|---|---|
| Pure Physics | NSGA-II 200g | 物理引擎 | 134s | **1.6456 m²** |
...
AGE-MOEA warm-start (1.658 m²) 优于 NSGA-II warm-start (1.692 m²)——AGE-MOEA 在短代际精炼场景下收敛更快。但两者均未超越纯物理 ground truth (1.682 m²)，差距 0.7%。
...
|---|---|---|---|---|---|---|
| 5×5m | 115s | 0.21 m² | 1.4% | 2.65 | 1.82 | 0.12 |
...
动态房间模型：21 特征 LGBM, Feasible MAE 0.25%, HV dev 0.5-3.3% 跨 4 房间。
